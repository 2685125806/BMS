...
class CodeGenerator {
    ...
    public void genCode() {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/" + moduleName+"?serverTimezone=Asia/Shanghai");
        ...
        strategy.setInclude(tables);//设置要映射的表名
